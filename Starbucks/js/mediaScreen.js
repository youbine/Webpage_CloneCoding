...
if (matchMedia("screen and (min-width: 0px) and (max-width: 960px)").matches) {
...
if (matchMedia("screen and (min-width: 0px) and (max-width: 930px)").matches) {
  reserveImg.src =
...
if (matchMedia("screen and (min-width: 0px) and (max-width: 819px)").matches) {
...
if (matchMedia("screen and (min-width: 0px) and (max-width: 640px)").matches) {
